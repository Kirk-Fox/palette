...
#[cfg(not(feature = "float_lut16"))]
fn gen_into_linear_lut_u16(_writer: &mut File, _entries: &[LutEntryU16]) {}
...
#[cfg(not(feature = "fast_uint_lut"))]
fn gen_from_linear_lut_u8(_writer: &mut File, _entries: &[LutEntryU8]) {}
